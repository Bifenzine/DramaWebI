...
import { getMoviesDetail, getPopularPeople } from '../../data/FetchingDataAxios'
...
import Sharebtn from '../../utilities/Sharebtn/Sharebtn'
            ...
            <div className='movie_detail flex justify-center items-center w-full  rounded-xl mx-2'>
                <div className='movie_detail-poster  w-full h-auto dark:bg-slate-950  bg-white rounded-xl shadowbox '>
                    <div className='movie_detail_poster relative '>
                        ...
                        <img className='w-full rounded-xl h-64 object-cover ' src={`https://image.tmdb.org/t/p/original/${movieDetail.backdrop_path}`} alt='poster' />
                    </div>
                    <div className='relative top-72 '>
                        <div className='movie_detail-imageMovie absolute  w-36 h-48 left-20   rounded-xl z-10 '>
                            <img className='rounded-xl absolute bottom-96 shadow-md ' src={`https://image.tmdb.org/t/p/original/${movieDetail.poster_path}`} alt='film' />
                        </div>

                        <Tooltip disableTouchListener title={`trailer of the${movieDetail.title}`}>
                            ...
                            <div className='description w-full bg-transparent'>
                                <div className='name_date_country_stat grid lg:pl-72 lg:pt-8 md:pl-60 md:pt-8 sm:pt-44   mb-8 pt-8 w-full '>
                                    <div className='grid w-full  justify-start '>
                                        ...
                                        <span className='text-2xl  flex '>{movieDetail.title}</span >
                                        <span className='Film__Origin text-xs  mb-4 pl-4 text-slate-400-400'>Film Origin : {movieDetail.production_countries[0].name} </span>
                                    ...
                                    <div className='flex  w-full  '>
                                        <div className='flex flex-wrap w-full'>
                                            ...
                                            <div className='grid sm:mb-4 dark:text-slate-400  px-4'>
                                                <Tooltip disableTouchListener title={`${movieDetail.vote_average} / 10`}>

                                                    <span >Rating : {movieDetail.vote_average} / 10 </span>
                                                </Tooltip>
                                                <Rating readOnly value={movieDetail.vote_average / 2} precision={0.1} />
                                ...
                                <div className='description w-full  px-8 pb-8  bg-transparent'>
                                    <div className='mx-4'>
                                        ...
                                        <div className='description border rounded-xl p-4 shadowbox '>
                                            <span className='dark:bg-slate-800' >{movieDetail.overview}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='detail-txt grid mx-8 p-4'>
                                    ...
                                    <div className='w-full border grid mt-4 shadow-lg p-4   rounded-2xl'>
                                        <div className='release_date w-fit border p-2 rounded-xl mb-4'>
                                            <span className='flex items-center dark:text-white'><FontAwesomeIcon className='mr-4 size-6 dark:text-slate-400' icon={faCalendarAlt} /> Release Date : <span className='text-gray-400 ml-2'>{movieDetail.release_date}</span></span>
                                        </div>
                                        <div className='duration w-fit border p-2  rounded-xl mb-4'>
                                            <span className='flex items-center dark:text-white'><FontAwesomeIcon className='mr-4 size-6 dark:text-slate-400' icon={faClock} /> Duration : <span className='text-gray-400 ml-2'>{movieDetail.runtime} min</span></span>
                                        </div>
                                        ...
                                        <div className='genres w-fit border p-2 rounded-xl  mb-4'>
                                            <span className='flex items-center dark:text-white'><FontAwesomeIcon className='mr-4 size-6 dark:text-slate-400' icon={faBlackboard} /> Genres : <span className='text-gray-400 ml-2'>{movieDetail.genres[0].name}</span></span>
                                        </div>
                                        <div className='tags w-fit border p-2 rounded-xl  '>
                                            <span className='flex items-center dark:text-white'><FontAwesomeIcon className='mr-4 size-6 dark:text-slate-400' icon={faCalendarAlt} /> Tags : <span className='text-gray-400 ml-2'>" {movieDetail.tagline} "</span></span>
                                        </div>
